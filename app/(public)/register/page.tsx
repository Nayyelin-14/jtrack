...
import { ArrowLeft, Briefcase, FileText, Loader2, Upload, X } from "lucide-react";
    ...
    <GuestGuard>
      <div className="relative grid min-h-screen place-items-center overflow-hidden px-4 py-12">
        ...
        <motion.div
          ...
          className="glass w-full max-w-lg rounded-3xl p-8 shadow-glow"
        >
          ...
          <p className="mt-1 text-center text-sm text-muted-foreground">Start tracking in under a minute</p>
            ...
            {role === "jobseeker" && (
              ...
              >
                ...
                {resume ? (
                  ...
                  <label className="flex cursor-pointer items-center justify-center gap-2 rounded-lg border border-dashed border-border bg-muted/20 px-3 py-4 text-sm text-muted-foreground transition hover:bg-muted/40 hover:text-foreground">
